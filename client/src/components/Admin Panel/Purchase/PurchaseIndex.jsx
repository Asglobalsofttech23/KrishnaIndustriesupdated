...
// import React, { useEffect, useState } from "react";
// import AddPurchase from "./AddPurchase";
// import UpdatePurchase from "./UpdatePurchase"; // Import the UploadExcell component
// import axios from "axios";
// import Search from "../../Search Option/Search";
// import Stack from '@mui/material/Stack';
// import Pagination from '@mui/material/Pagination'
// import PurchaseInvoice from "./PurchaseInvoice";
// import config from '../../../config'
// import UploadExcell from "./UploadExell";
...
const PurchaseIndex = () => {
  ...
  const handleDateFilter = () => {
    if (startDate && endDate) {
      const filteredData = purchData.filter((purch) => {
        const purchDate = format(new Date(purch.created_at), 'yyyy-MM-dd');
        return purchDate >= startDate && purchDate <= endDate;
      });
      setSearchPurchData(filteredData);
    } else {
      setSearchPurchData(purchData);
    }
  };
          ...
          <TableBody>
            {currentData.map((purch, index) => (
              <TableRow key={index}>
                ...
                <TableCell>
                                    {(() => {
                                        const formattedDate = format(new Date(purch.created_at), 'dd/MM/yyyy HH:mm:ss');
                                ...
                                </TableCell>                <TableCell>{purch.total}</TableCell>
                <TableCell>{purch.gst}</TableCell>
                <TableCell>
                  <Button onClick={() => handleInvoice(purch.purch_id)}>Invoice</Button>
                  <Button onClick={() => handleEdit(purch.purch_id)}>Edit</Button>
