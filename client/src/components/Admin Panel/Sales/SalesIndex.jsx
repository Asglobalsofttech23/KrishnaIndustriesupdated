...
// import DateFilter from '../Purchase/DateFilter';
...
//             });
//             setSearchSalesData(filteredData);
//         } else {
//             setSearchSalesData(salesData);
//         }
//     };
...
//                                 <TableCell>{sale.quantity}</TableCell>
//                                 <TableCell>{sale.price}</TableCell>
//                                 <TableCell>{format(new Date(sale.created_at), 'dd/MM/yyyy')}</TableCell> {/* Format the date */}
//                                 <TableCell>{sale.gst}</TableCell>
//                                 <TableCell>{sale.total}</TableCell>
//                                 <TableCell>
//                                     {/* <Button onClick={()=>handleInvoice(sale.sale_id)}>Invoice</Button> */}
